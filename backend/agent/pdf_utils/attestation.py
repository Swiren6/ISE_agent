...
def export_attestation_pdf(donnees):
    ...
    base_path = Path(__file__).parent
    font_path_regular = base_path / ".." / "fonts" / "Amiri-1.002" / "Amiri-Regular.ttf"
    font_path_bold = base_path / ".." / "fonts" / "Amiri-1.002" / "Amiri-Bold.ttf"

    # Conversion en chemin absolu string
